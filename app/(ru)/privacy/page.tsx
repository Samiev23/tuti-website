      ...
      <main className="flex-1 px-5 py-10 md:py-16">
        <article className="max-w-3xl mx-auto bg-white rounded-3xl border border-border-light shadow-sm p-6 md:p-10">
          ...
          <div className="mt-4 mb-8 text-sm md:text-[15px] text-text-muted space-y-1">
            ...
            <p>
              <B>Последнее обновление:</B> 18 августа 2026 г.
            </p>
          </div>
          ...
          <Section id="vozrastnoe-ogranichenie" title="2. Возрастное ограничение">
            <P>
              ...
              <B>исключительно для лиц, достигших 18 лет</B>.
            </P>
            <P>
              Создавая учётную запись, вы подтверждаете, что вам исполнилось 18
              лет. Мы сознательно не собираем данные лиц младше 18 лет.
            </P>
            <P>
              Если нам станет известно, что учётная запись создана
              несовершеннолетним, мы удалим её и связанные с ней данные. Если вы
              считаете, что несовершеннолетний предоставил нам свои данные,
              напишите на <Mail address="tutiapp08@gmail.com" /> — мы удалим их в
              кратчайший срок.
            </P>
          </Section>
